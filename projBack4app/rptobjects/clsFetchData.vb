...
Public Class clsFetchData
    ...
    Public Event DataDownloaded(isSuccess As Boolean, rptType As Int16)

    Public blRecord As BindingList(Of clsRecord)

    Private m_FromDate, m_ToDate, m_RangeType As String
    ' 0 implies listed report
    ' else implies item-grouped report
    Private m_rptType As Int16

    Public ReadOnly Property rptType() As Int16
        Get
            Return m_rptType
        End Get
    End Property
    ...
    Public Function getRangeRecords(fromdate As Date, todate As Date, Optional ByVal rptType As Int16 = 0) As Boolean
        ' using TLS 1.2
        ...
        Catch ex As Exception
            ...
            RaiseEvent DataDownloaded(False, -1)
            Return False
        End Try
    End Function
    ...
    Private Sub webClient_DownloadStringCompleted2(ByVal sender As Object, ByVal e As DownloadStringCompletedEventArgs)
        ...
        RaiseEvent DataDownloaded(True, m_rptType)
    End Sub
