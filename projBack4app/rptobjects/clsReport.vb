...
Public Class clsReport
    ...
    Private xmlFile, xsdFile, rptFile, rptFile2 As String
    ...
    Sub New()
        ...
        rptFile2 = IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Fastreport", "ProductionReportGroupByItem.frx")
    End Sub
    ...
    Public Function ShowReport(ByRef blRecord As BindingList(Of clsRecord), Optional ByVal rptType As Int16 = 0) As Boolean
